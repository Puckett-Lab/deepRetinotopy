...
test_dataset = Retinotopy(path, 'Test', transform=T.Cartesian(),
                          ...
                          hemisphere='Left', fit='3') # fit 2 or 3
...
model.load_state_dict(torch.load(
    ...
    '/model4_nothresh_rotated_12layers_smoothL1lossR2_curvnmyelin_ROI1_k25_batchnorm_dropout010_3.pt',
    map_location='cpu'))
...
torch.save({'Predicted_values': evaluation['Predicted_values'],
           ...
           osp.join(osp.dirname(osp.realpath(__file__)), 'testset_results',
                    'testset-pred_Model3_PA_LH_fit3.pt'))
