...
class Retinotopy(InMemoryDataset):
    ...
    def processed_file_names(self):
        if self.myelination==True:
            if self.prediction == 'eccentricity':
                return ['training_ecc_visual_nothresh_rotated_myelincurv_glasser_v2.pt', 'development_ecc_visual_nothresh_rotated_myelincurv_glasser_v2.pt',
                        'test_ecc_visual_nothresh_rotated_myelincurv_glasser_v2.pt']
            else:
                return ['training_PA_visual_nothresh_rotated_myelincurv_glasser_v2.pt', 'development_PA_visual_nothresh_rotated_myelincurv_glasser_v2.pt',
                        'test_PA_visual_nothresh_rotated_myelincurv_glasser_v2.pt']
        else:
            if self.prediction=='eccentricity':
                return ['training_ecc_visual_nothresh_rotated_glasser_v2.pt','development_ecc_visual_nothresh_rotated_glasser_v2.pt','test_ecc_visual_nothresh_rotated_glasser_v2.pt']
            else:
                return ['training_PA_visual_nothresh_rotated_glasser_v2.pt','development_PA_visual_nothresh_rotated_glasser_v2.pt','test_PA_visual_nothresh_rotated_glasser_v2.pt']
    ...
    def process(self):
        ...
        label_primary_visual_areas = ['V1', 'V2', 'V3','V4','V3a','V3b','LO1','LO2','PIT','V8','VMV3','VMV2','VMV1']
