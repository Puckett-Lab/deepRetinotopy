    ...
    def processed_file_names(self):
        if self.myelination==True:
            if self.prediction == 'eccentricity':
                return ['training_ecc_visual_nothresh_rotated_myelincurv_v2.pt', 'development_ecc_visual_nothresh_rotated_myelincurv_v2.pt',
                        'test_ecc_visual_nothresh_rotated_myelincurv_v2.pt']
            else:
                return ['training_PA_visual_nothresh_rotated_myelincurv_v2.pt', 'development_PA_visual_nothresh_rotated_myelincurv_v2.pt',
                        'test_PA_visual_nothresh_rotated_myelincurv_v2.pt']
        else:
            if self.prediction=='eccentricity':
                return ['training_ecc_visual_nothresh_rotated_v2.pt','development_ecc_visual_nothresh_rotated_v2.pt','test_ecc_visual_nothresh_rotated_v2.pt']
            else:
                return ['training_PA_visual_nothresh_rotated_v2.pt','development_PA_visual_nothresh_rotated_v2.pt','test_PA_visual_nothresh_rotated_v2.pt']
