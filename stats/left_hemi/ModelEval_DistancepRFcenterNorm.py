...
def pRF_distance(model):
    ...
    Output: .npz files in ./../output named:
        'ErrorPerParticipant_pRFcenter_LH_WangParcels_' + str(model) + '_1-8.npz'
        'ErrorPerParticipant_pRFcenter_LH_EarlyVisualCortex_' + str(model) + '_1-8.npz'
        'ErrorPerParticipant_pRFcenter_LH_dorsalV1-3_' + str(model) + '_1-8.npz'
