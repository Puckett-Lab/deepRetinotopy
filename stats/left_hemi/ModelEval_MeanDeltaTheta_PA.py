...
def PA_difference(model):
    ...
    Output: .npz files in ./../output named:
        ...
        'ErrorPerParticipant_PA_LH_EarlyVisualCortex_' + str(model) + '_1-8.npz'
    ...
    # Benson14 template
    Benson14_predictions = np.load('./../..//benson14_testPrediction.npz')['list']
    ...
    np.savez('./../output/ErrorPerParticipant_PA_LH_WangParcels_' + str(model) + '_1-8.npz',
    ...
    np.savez('./../output/ErrorPerParticipant_PA_LH_EarlyVisualCortex_' + str(model) + '_1-8'
