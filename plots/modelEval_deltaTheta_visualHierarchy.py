...
for k in range(len(visual_areas)):
    ...
    for m in range(12):
        a=torch.load('/home/uqfribe1/PycharmProjects/DEEP-fMRI/polarAngle/model4_nothresh_rotated_'+str(m+1)+'layers_smoothL1lossR2_curvnmyelin_ROI1_k25_batchnorm_dropout010_output_epoch100.pt',map_location='cpu')
