...
# 'cifti_polarAngle']
# pred=np.reshape(polarangle['x100610_fit1_polarangle_msmall'][0][0][
# 0:32492],(-1))
...
# myelin_s[final_mask_L==1]=np.reshape(np.array(a['Shuffled_myelin'][3]),
# (-1,1))
...
# plotting.plot_surf(surf_mesh=osp.join(osp.dirname(osp.realpath(__file__)),
# '../..','data/raw/original/S1200_7T_Retinotopy_9Zkk/S1200_7T_Retinotopy181
# /MNINonLinear/fsaverage_LR32k/S1200_7T_Retinotopy181.L.midthickness_MSMAll
# .32k_fs_LR.surf.gii'),surf_map=np.reshape(measured[0:32492],(-1)),
# bg_map=background,cmap='gist_rainbow_r',symmetric_cbar=False,vmax=361,
# view='posterior',avg_method='median',threshold=threshold+360,
# output_file='L_curv_sub8_posterior_.svg')
# plotting.show()
