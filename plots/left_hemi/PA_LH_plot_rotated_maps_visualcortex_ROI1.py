...
background=np.reshape(curv['x131722_curvature'][0][0][0:32492],(-1))
...
a=torch.load('/home/uqfribe1/PycharmProjects/DEEP-fMRI/testing_shuffled-myelincurv.pt',map_location='cpu')
...
view=plotting.view_surf(surf_mesh=osp.join(osp.dirname(osp.realpath(__file__)),'../..','data/raw/original/S1200_7T_Retinotopy_9Zkk/S1200_7T_Retinotopy181/MNINonLinear/fsaverage_LR32k/S1200_7T_Retinotopy181.L.sphere.32k_fs_LR.surf.gii'),surf_map=np.reshape(curv_s[0:32492],(-1)),bg_map=background,cmap='gray',black_bg=True,symmetric_cmap=False,threshold=threshold)
