...
for k in range(len(visual_areas)):
    ...
    for m in range(len(models)):
        a = torch.load(
            '/home/uqfribe1/PycharmProjects/DEEP-fMRI/Final-pred_Model' +
            models[m] + '_ecc_LH.pt', map_location='cpu')
...
for m in range(len(models)):
    a = torch.load(
        '/home/uqfribe1/PycharmProjects/DEEP-fMRI/Final-pred_Model' + models[
            m] + '_ecc_LH.pt',
        map_location='cpu')
