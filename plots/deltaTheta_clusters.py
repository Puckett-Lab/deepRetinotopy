...
#Higher order visual areas (clusters)
...
for k in range(len(visual_areas)):
    ...
    for m in range(13):
        ...
        if m<12:
            a = torch.load('/home/uqfribe1/PycharmProjects/DEEP-fMRI/polarAngle/model4_nothresh_rotated_' + str(
                m + 1) + 'layers_smoothL1lossR2_curvnmyelin_ROI1_k25_batchnorm_dropout010_output_epoch200.pt',
                           map_location='cpu')
            ...
            a = torch.load('/home/uqfribe1/PycharmProjects/DEEP-fMRI/polarAngle/model4_nothresh_rotated_' + str(
                m + 8) + 'layers_smoothL1lossR2_curvnmyelin_ROI1_k25_batchnorm_dropout010_output_epoch200.pt',
                           map_location='cpu')
            # b=torch.load('/home/uqfribe1/PycharmProjects/DEEP-fMRI/testing_shuffled-myelin.pt',map_location='cpu')
    ...
    labels.append(20)
    ax.scatter(labels,mean_delta)
    ax.scatter(labels,mean_across)
...
for m in range(13):
    if m<12:
        a=torch.load('/home/uqfribe1/PycharmProjects/DEEP-fMRI/polarAngle/model4_nothresh_rotated_'+str(m+1)+'layers_smoothL1lossR2_curvnmyelin_ROI1_k25_batchnorm_dropout010_output_epoch200.pt',map_location='cpu')
        #b=torch.load('/home/uqfribe1/PycharmProjects/DEEP-fMRI/testing_shuffled-myelin.pt',map_location='cpu')
