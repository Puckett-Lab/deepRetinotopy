...
def ecc_difference(model):
    ...
    Output: .npz files in ./../output named:
        'ErrorPerParticipant_ecc_RH_WangParcels_' + str(model) + '_1-8.npz'
        'ErrorPerParticipant_ecc_RH_EarlyVisualCortex_' + str(model) +
        '_1-8.npz'
        'ErrorPerParticipant_ecc_RH_dorsalV1-3_' + str(model) + '_1-8.npz'
    ...
    Benson14_predictions = \
        np.load(
            './../../testset_results/benson14/benson14_testPrediction_ecc_rh'
            '.npz')[
            'list']
