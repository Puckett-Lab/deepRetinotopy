...
for epoch in range(1, 301):
    ...
    if epoch%50==0:
        ...
        #                                         'modelparameters_nothresh_RH_12layers_smoothL1lossR2_curvnmyelin_ROI1_k25_batchnorm_dropout010_2_epoch' + str(
        #                                             epoch) + '.pt'))
...
torch.save(model.state_dict(),osp.join(osp.dirname(osp.realpath(__file__)),'..','output','model4_300_nothresh_RH_12layers_smoothL1lossR2_curvnmyelin_ROI1_k25_batchnorm_dropout010_2.pt'))
