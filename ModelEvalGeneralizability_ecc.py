...
model.load_state_dict(torch.load(
    ...
    '/model4_nothresh_ecc_12layers_smoothL1loss_curvnmyelin_ROI1_k25_batchnorm_dropout010_4.pt',
    map_location='cpu'))
...
#            osp.join(osp.dirname(osp.realpath(__file__)), 'testset_results',
#                     'testset-shuffled-myelincurv_Model4_ecc_LH.pt'))



# Evaluating trained model on the test dataset (shuffled curvature and empirical myelin
# values)
# def test():
#     model.eval()
#     MeanAbsError=0
...
# Evaluating trained model on the test dataset (empirical curvature and shuffled myelin
# values)
# def test():
#     model.eval()
#     MeanAbsError = 0
...
# 'Measured_values': evaluation['Measured_values']},
#            osp.join(osp.dirname(osp.realpath(__file__)),'testset_results',
#            'testset-constant_Model4_ecc_LH.pt'))
